...
export function EmptyState({ title, description, action }: EmptyStateProps) {
  return (
    <div className="flex min-h-[220px] flex-col items-center justify-center rounded-lg border border-dashed border-border yellow-50 p-8 text-center">
      ...
      <h3 className="font-display text-lg font-bold text-green">{title}</h3>
