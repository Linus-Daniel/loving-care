...
export default function About() {
  ...
  return (
    <div className="overflow-x-hidden">
      ...
      {/* ═══════ FOOTER PREVIEW ═══════ */}
      <section className="py-16 bg-secondary-50 text-primary mt-20 border-t border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-10">
            <div className="md:col-span-2">
              ...
              >
                <h3 className="text-2xl font-display font-bold mb-4 flex items-center gap-2">
                  <Heart className="w-6 h-6 text-accent-400 fill-current" />
                  Loving Family Daycare
                </h3>
                <p className="text-muted-foreground leading-relaxed max-w-md">
                  Providing a warm, nurturing environment where children can grow, learn, and thrive since 2015. Your child's second home.
                </p>
              </motion.div>
            </div>
            ...
            >
              ...
              <ul className="space-y-2 text-muted-foreground">
                {['Programs', 'Gallery', 'Events', 'About Us', 'Contact'].map((link) => (
                  <li key={link}>
                    <button
