  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
      <div className="text-center mb-10">
        ...
        <h1 className="text-3xl lg:text-4xl font-display font-bold text-green-500">Privacy Policy</h1>
        <p className="text-muted-foreground mt-2">Last updated: May 1, 2024</p>
      </div>

      <div className="prose prose-sm max-w-none text-muted-foreground space-y-6">
        <section>
          <h2 className="text-lg font-display font-semibold text-green-500">1. Introduction</h2>
        ...
        <section>
          <h2 className="text-lg font-display font-semibold text-green-500">2. Information We Collect</h2>
        ...
        <section>
          <h2 className="text-lg font-display font-semibold text-green-500">3. How We Use Your Information</h2>
        ...
        <section>
          <h2 className="text-lg font-display font-semibold text-green-500">4. Information Sharing</h2>
        ...
        <section>
          <h2 className="text-lg font-display font-semibold text-green-500">5. Data Security</h2>
        ...
        <section>
          <h2 className="text-lg font-display font-semibold text-green-500">6. Your Rights</h2>
        ...
        <section>
          <h2 className="text-lg font-display font-semibold text-green-500">7. Contact Us</h2>
