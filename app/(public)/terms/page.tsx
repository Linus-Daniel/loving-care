  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
      <div className="text-center mb-10">
        ...
        <h1 className="text-3xl lg:text-4xl font-display font-bold text-green">Terms & Conditions</h1>
        <p className="text-muted-foreground mt-2">Last updated: May 1, 2024</p>
      </div>

      <div className="prose prose-sm max-w-none text-muted-foreground space-y-6">
        <section>
          <h2 className="text-lg font-display font-semibold text-green">1. Acceptance of Terms</h2>
        ...
        <section>
          <h2 className="text-lg font-display font-semibold text-green">2. Enrollment and Registration</h2>
        ...
        <section>
          <h2 className="text-lg font-display font-semibold text-green">3. Fees and Payments</h2>
        ...
        <section>
          <h2 className="text-lg font-display font-semibold text-green">4. Attendance and Pick-up</h2>
        ...
        <section>
          <h2 className="text-lg font-display font-semibold text-green">5. Health and Safety</h2>
        ...
        <section>
          <h2 className="text-lg font-display font-semibold text-green">6. Photography and Media</h2>
        ...
        <section>
          <h2 className="text-lg font-display font-semibold text-green">7. Termination</h2>
        ...
        <section>
          <h2 className="text-lg font-display font-semibold text-green">8. Liability</h2>
        ...
        <section>
          <h2 className="text-lg font-display font-semibold text-green">9. Changes to Terms</h2>
        ...
        <section>
          <h2 className="text-lg font-display font-semibold text-green">10. Contact</h2>
