...
export default function AdminLoginPage() {
  return (
    <div className="grid min-h-screen lg:grid-cols-2">
      <section className="hidden bg-green p-10 text-white lg:flex lg:flex-col lg:justify-between">
        <div className="flex items-center gap-3">
          <span className="flex h-12 w-12 items-center justify-center rounded-full bg-yellow text-green">
        ...
        <div>
          <p className="mb-3 inline-flex items-center gap-2 rounded-full yellow-50/10 px-3 py-1 text-sm">
            <Shield className="h-4 w-4 text-yellow" />
            Admin Portal Access
          </p>
          <h1 className="max-w-md font-display text-4xl font-extrabold leading-tight text-yellow">
      ...
      <section className="flex items-center justify-center bg-muted p-4">
        <div className="w-full max-w-md rounded-2xl yellow-50 p-6 shadow-card lg:p-8">
          <div className="mb-6 text-center">
            <p className="mb-2 inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-teal">
              <Shield className="h-4 w-4" />
              Admin Portal Access
            </p>
            <h2 className="font-display text-2xl font-bold text-green">Admin Sign In</h2>
